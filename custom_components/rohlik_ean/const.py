...
CONF_SCAN_AGGREGATION: Final = "scan_aggregation_seconds"
...
DEFAULT_SCAN_AGGREGATION: Final = 4
...
OFF_USER_AGENT: Final = "ha-rohlik-ean/0.9.0 (https://github.com/hruskin/ha-rohlik-ean)"
